...
from einops import rearrange, reduce, repeat, unpack
...
class PatchEmbedding(nn.Module):
    ...
    def __init__(self, img_size: int=224, patch_size: int=16, in_chans=3, embed_dim=768):
        ...
        self.positions = nn.Parameter(torch.rand(1, (img_size[0] // patch_size[0])**2 + 1, embed_dim))
...
class Block(nn.Module):
    def __init__(self, dim, num_heads=8, mlp_ratio=4, qkv_bias=False, drop_rate=0.):
        ...
        # Attention
        self.attention = Attention(dim, num_heads, qkv_bias=qkv_bias, attn_drop=drop_rate, out_drop=drop_rate)
...
class Transformer(nn.Module):
    def __init__(self, depth, dim, num_heads=8, qkv_bias=False, mlp_ratio=4, drop_rate=0.):
        super().__init__()
...
class ViT(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000,
        ...
        # Transformer Encoder
        self.transformer = Transformer(depth, embed_dim, num_heads, qkv_bias, mlp_ratio, drop_rate)
